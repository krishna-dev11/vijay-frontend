...
import { ChevronLeft, ChevronRight } from "lucide-react";
import krishna from "../../../assets/Instructor/krishnaimage.png"
import khushi from "../../../assets/Instructor/khushiimage.png"
      ...
      <section className="w-full min-h-screen bg-black px-6 sm:px-10 lg:px-16 py-16 font-dm">
        ...
        >
          ...
          <div className="relative flex items-end justify-center overflow-hidden min-h-[360px] lg:min-h-[480px]">
            ...
            {/* --- YAHAN IMAGE ACTUAL LAG RAHI HAI --- */}
            <div className="relative z-10 flex flex-col items-center justify-end h-full w-full">
               <img 
                 src={instructor.image} 
                 alt={instructor.name}
                 className="max-h-[95%]  translate-x-10 w-auto object-contain anim-fade"
