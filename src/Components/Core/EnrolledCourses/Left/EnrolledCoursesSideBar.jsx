...
const EnrolledCoursesSideBar = () => {
  ...
  return (
    <div className="
      ...
      w-full sm:w-[240px] 
      bg-[#0a0a0a] 
      border-t sm:border-t-0 sm:border-r border-white/5 
      py-3 sm:py-8 
      justify-between 
    ...
    ">
      ...
      {/* ─── TOP: NAVIGATION ─── */}
      <div className="flex flex-row sm:flex-col gap-2 sm:gap-y-1 px-3 sm:px-4 w-full">

        {/* Title hidden on mobile */}
        <div className="hidden sm:flex flex-col mb-6 ml-4">
        ...
        {/* Nav Links */}
        <div className="flex flex-row sm:flex-col text-white gap-2 sm:gap-y-2 w-full overflow-x-auto sm:overflow-visible">
          {BuyedCoursessidebarLinks.map((link, index) => (
      ...
      ">
        ...
        <button
          ...
          className="
            ...
            px-3 py-2 sm:py-3 
            hover:bg-[#10b981] hover:text-black 
            transition-all
          "
        >
          <FaStore className="text-white" />
          <p className="hidden sm:block text-[10px] font-bold uppercase text-white tracking-[0.2em]">
            Visit Academy Store
          </p>
        </button>
        ...
        >
          <div className="relative shrink-0">
            ...
            <div className="absolute -bottom-1 -right-1 w-2.5 h-2.5 bg-[#10b981] border-2 border-[#0a0a0a] rounded-full" />
          </div>
